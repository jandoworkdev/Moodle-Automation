  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-wider">SYSTEM STATUS</h1>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-white font-mono">5/6</p>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1 text-xs text-neutral-400">
                <div className="flex justify-between">
                  <span>Version:</span>
                  <span className="text-white font-mono">{system.version}</span>
                </div>
                <div className="flex justify-between">
                  <span>Uptime:</span>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="text-white font-mono">{selectedSystem.version}</span>
                      </div>
                      <div className="flex justify-between">
