...
import { Workflow, Play, Pause, CheckCircle, Clock, AlertTriangle, ArrowRight } from "lucide-react"
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-orange-500 hover:bg-orange-600 text-white">Create Flow</Button>
          <Button className="bg-orange-500 hover:bg-orange-600 text-white">Import Template</Button>
        </div>
      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      {selectedFlow.actions.map((action, index) => (
                        <div key={index} className="flex items-center gap-3 p-2 bg-neutral-800 rounded">
                          <div className="w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center text-xs text-white font-bold">
                            {index + 1}
                          </div>
                          <div>
